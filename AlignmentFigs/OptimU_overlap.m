% Final one for alignment figs
% change terms to omega's, use same term as in the paper. 
% checks if optimal u selected by the system is the one that has largest
% overlap with the final system. 
% @pragyasr: summer 2020
